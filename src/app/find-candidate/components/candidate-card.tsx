...
import { EnvironmentOutlined, DollarOutlined, MessageOutlined, ArrowRightOutlined } from '@ant-design/icons';

export default function CandidateCard() {
  return <div className="flex items-center w-2/6 h-24 p-3 bg-white rounded-md">
    ...
    <Button type="link" icon={<MessageOutlined className="text-black" />} />
